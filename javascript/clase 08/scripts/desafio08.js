...
function menu (){
    let seleccioneOpcion = prompt("Seleccione opcion: 1 para cargar, 2 para listar, 3 para salir");

    if (seleccioneOpcion == 1){
        cargarMedico(); //en caso de cargar salta a la funcion para ingresar datos
    }else if(seleccioneOpcion == 2){
...
function cargarMedico(){ //le pide al usuario que ingrese sus datos
    ...
    document.getElementById("saludo").innerHTML = "Bienvenido Dr/a " + nuevoMedico.nombre + " " + nuevoMedico.apellido + " su perfil se guardo correctamente";
...
// Insertar HTML interno
    parrafo.innerHTML = "<h2>Especialidad: "+ especialidad +"</h2>"; 
